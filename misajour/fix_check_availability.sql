-- =============================================
-- DALIGHT — Fix check_availability Duplicate Function
-- Fichye: fix_check_availability.sql
-- Kouri nan Supabase SQL Editor
-- =============================================
-- PWOBLEM: function check_availability(date, time without time zone) is not unique
-- SOLISYON: Drop tout vèsyon check_availability epi rekreye yon sèl
-- =============================================

-- 1. Drop tout vèsyon check_availability (toute sinatir posib)
...
-- 2. Drop get_month_availability tou (li depann de check_availability)
...
-- 3. Rekreye check_availability ak bon sinatir
...
-- 4. Rekreye get_month_availability
